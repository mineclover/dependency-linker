...
if (validation.valid) {
  ...
  console.log(`   총 ${EdgeTypeRegistry.getAll().length}개의 edge types 정의됨\n`);
} else {
...
const typesToCheck = ['imports_library', 'imports_file', 'imports', 'calls', 'extends'];
...
console.log('  const typesToRegister = EdgeTypeRegistry.getTypesForDynamicRegistration();');
