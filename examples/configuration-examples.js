...
function main() {
	log(
		`${colors.bright}${colors.blue}TypeScript Dependency Linker - Configuration Examples${colors.reset}`,
	);
	log(
	...
	runCommand("List All Available Presets", "./analyze-file config list");
