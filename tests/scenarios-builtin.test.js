...
(0, globals_1.describe)("Built-in Scenarios", () => {
    ...
    (0, globals_1.describe)("Scenario Specifications", () => {
        (0, globals_1.it)("should have valid basic-structure spec", () => {
            (0, globals_1.expect)(() => registry.register(builtin_1.basicStructureSpec)).not.toThrow();
        ...
        (0, globals_1.it)("should have valid file-dependency spec", () => {
            ...
            (0, globals_1.expect)(() => registry.register(builtin_1.fileDependencySpec)).not.toThrow();
            (0, globals_1.expect)(registry.has("file-dependency")).toBe(true);
        });
        (0, globals_1.it)("should have valid symbol-dependency spec", () => {
            registry.register(builtin_1.basicStructureSpec);
            (0, globals_1.expect)(() => registry.register(builtin_1.symbolDependencySpec)).not.toThrow();
            (0, globals_1.expect)(registry.has("symbol-dependency")).toBe(true);
        });
        (0, globals_1.it)("should have valid markdown-linking spec", () => {
            registry.register(builtin_1.basicStructureSpec);
            (0, globals_1.expect)(() => registry.register(builtin_1.markdownLinkingSpec)).not.toThrow();
        ...
        (0, globals_1.it)("should have valid method-analysis spec", () => {
            ...
            (0, globals_1.expect)(() => registry.register(builtin_1.methodAnalysisSpec)).not.toThrow();
    ...
    (0, globals_1.describe)("Scenario Dependencies", () => {
        ...
        (0, globals_1.it)("should resolve execution order for file-dependency", () => {
            registry.register(builtin_1.basicStructureSpec);
            registry.register(builtin_1.fileDependencySpec);
            const order = registry.getExecutionOrder(["file-dependency"]);
            (0, globals_1.expect)(order).toEqual(["basic-structure", "file-dependency"]);
        });
        (0, globals_1.it)("should resolve execution order for multiple scenarios", () => {
            registry.register(builtin_1.basicStructureSpec);
            registry.register(builtin_1.fileDependencySpec);
            registry.register(builtin_1.symbolDependencySpec);
    ...
    (0, globals_1.describe)("Type Collections", () => {
        ...
        (0, globals_1.it)("should inherit types from basic-structure in file-dependency", () => {
            registry.register(builtin_1.basicStructureSpec);
            registry.register(builtin_1.fileDependencySpec);
            ...
            (0, globals_1.expect)(types.edgeTypes.has("imports_library")).toBe(true);
        });
        (0, globals_1.it)("should inherit types from basic-structure in symbol-dependency", () => {
            registry.register(builtin_1.basicStructureSpec);
            registry.register(builtin_1.symbolDependencySpec);
        ...
        (0, globals_1.it)("should inherit types from basic-structure in markdown-linking", () => {
            registry.register(builtin_1.basicStructureSpec);
            registry.register(builtin_1.markdownLinkingSpec);
            const types = registry.collectTypes("markdown-linking");
            (0, globals_1.expect)(types.nodeTypes.has("file")).toBe(true);
            (0, globals_1.expect)(types.nodeTypes.has("markdown-document")).toBe(true);
            ...
            (0, globals_1.expect)(types.edgeTypes.has("md-embeds-image")).toBe(true);
        });
    });
    (0, globals_1.describe)("Edge Type Hierarchy", () => {
        (0, globals_1.it)("should define parent relationships for file-dependency edges", () => {
            registry.register(builtin_1.basicStructureSpec);
            registry.register(builtin_1.fileDependencySpec);
            const spec = registry.get("file-dependency");
            const importsFile = spec.edgeTypes.find((e) => e.name === "imports_file");
            const importsLibrary = spec.edgeTypes.find((e) => e.name === "imports_library");
        ...
        (0, globals_1.it)("should define hierarchical relationships", () => {
            ...
            const extendsClass = symbolSpec.edgeTypes.find((e) => e.name === "extends-class");
    ...
    (0, globals_1.describe)("Built-in Constants", () => {
        ...
        (0, globals_1.it)("should have consistent IDs in specs and constants", () => {
            (0, globals_1.expect)(builtin_1.basicStructureSpec.id).toBe(builtin_1.BUILTIN_SCENARIOS[0]);
            (0, globals_1.expect)(builtin_1.fileDependencySpec.id).toBe(builtin_1.BUILTIN_SCENARIOS[1]);
            (0, globals_1.expect)(builtin_1.symbolDependencySpec.id).toBe(builtin_1.BUILTIN_SCENARIOS[2]);
            (0, globals_1.expect)(builtin_1.markdownLinkingSpec.id).toBe(builtin_1.BUILTIN_SCENARIOS[3]);
            (0, globals_1.expect)(builtin_1.methodAnalysisSpec.id).toBe(builtin_1.BUILTIN_SCENARIOS[4]);
        });
    });
});
