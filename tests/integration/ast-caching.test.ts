...
export const Component = () => <div>Test</div>;
      ...
      const firstResult = {
        filePath,
        language: 'typescript',
        extractedData: { imports: [{ source: 'react', specifiers: ['React'] }] },
        interpretedData: {},
      ...
      const secondResult = {
        ...firstResult,
        performanceMetrics: { parseTime: 2, extractionTime: 1, interpretationTime: 1, totalTime: 4, memoryUsage: 1024 },
        cacheHit: true
      };
      ...
      expect(result2.performanceMetrics.totalTime).toBeLessThan(result1.performanceMetrics.totalTime);
    });
