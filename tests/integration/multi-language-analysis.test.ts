      ...
      const mockResult = {
        ...
        extractedData: {
          imports: [
            ...
            { source: './utils', specifiers: ['*'], type: 'namespace', alias: 'utils' }
          ],
          exports: [
        ...
        performanceMetrics: { parseTime: 25, extractionTime: 10, interpretationTime: 5, totalTime: 40, memoryUsage: 2048 },
        errors: []
      };
  ...
  render( {
    // Missing closing parenthesis and bracket
      ...
      const mockResult = {
        ...
        extractedData: {},
        interpretedData: {},
        performanceMetrics: { parseTime: 5, extractionTime: 0, interpretationTime: 0, totalTime: 5, memoryUsage: 512 },
        errors: [{
          type: 'SyntaxError',
      ...
      const mockResult = {
        ...
        extractedData: {
          imports: [
            ...
            { source: './custom', type: 'require', specifiers: ['customModule'] }
          ],
          exports: [
            { type: 'module.exports', value: 'FileProcessor' },
            { type: 'module.exports.property', name: 'VERSION', value: '1.0.0' }
          ],
        ...
        performanceMetrics: { parseTime: 20, extractionTime: 8, interpretationTime: 4, totalTime: 32, memoryUsage: 1536 },
        errors: []
      };
...
export default useCustomHook;
      ...
      const mockResult = {
        ...
        extractedData: {
          imports: [
            { source: 'react', specifiers: ['React', 'useState', 'useEffect'], type: 'mixed' },
            { source: 'express', specifiers: ['Router'], type: 'named' },
            { source: '../config/index.js', specifiers: ['config'], type: 'default' }
          ],
          exports: [
        ...
        performanceMetrics: { parseTime: 18, extractionTime: 7, interpretationTime: 3, totalTime: 28, memoryUsage: 1280 },
        errors: []
      };
...
func main() {
  ...
  if err := server.Start(); err != nil {
    ...
    os.Exit(1)
      ...
      const mockResult = {
        ...
        extractedData: {
          ...
          imports: [
            ...
            { path: 'github.com/user/project/internal/config', type: 'internal' },
            { path: 'github.com/user/project/pkg/utils', type: 'internal', import_type: 'dot' }
          ],
          types: [
        ...
        interpretedData: {
          dependencyAnalysis: {
            ...
            internal: ['github.com/user/project/internal/config', 'github.com/user/project/pkg/utils'],
            summary: { total: 6, standard: 3, external: 1, internal: 2 }
          }
        },
        performanceMetrics: { parseTime: 30, extractionTime: 12, interpretationTime: 6, totalTime: 48, memoryUsage: 2560 },
        errors: []
      };
      ...
      expect(result.extractedData.dependencies).toContain('github.com/gorilla/mux');
    });
  });
...
public class UserService {
    ...
    public User saveUser(User user) {
      ...
      const mockResult = {
        ...
        extractedData: {
          ...
          imports: [
            ...
            { class: 'org.springframework.stereotype.Service', type: 'external' },
            { class: 'org.springframework.beans.factory.annotation.Autowired', type: 'external' },
            { class: 'com.example.model.User', type: 'internal' },
            { class: 'com.example.repository.UserRepository', type: 'internal' }
          ],
          classes: [
            {
              name: 'UserService',
              ...
              annotations: ['Service'],
              fields: [
                { name: 'userRepository', type: 'UserRepository', annotations: ['Autowired'] }
              ],
              methods: [
                { name: 'getAllUsers', returnType: 'List<User>', parameters: [], throws: ['IOException'] },
                { name: 'getUserById', returnType: 'User', parameters: ['Long id'] },
                { name: 'saveUser', returnType: 'User', parameters: ['User user'] }
              ]
            }
          ],
        ...
        performanceMetrics: { parseTime: 35, extractionTime: 15, interpretationTime: 8, totalTime: 58, memoryUsage: 3072 },
        errors: []
      };
      ...
      expect(result.extractedData.dependencies).toContain('org.springframework');
    });
  });
  ...
  describe('Batch Analysis', () => {
    test('should analyze multiple files of different languages', async () => {
      // Create test files
      const files = [
        { name: 'component.tsx', content: 'import React from "react"; export default () => <div>Test</div>;' },
        { name: 'server.js', content: 'const express = require("express"); module.exports = express();' },
        { name: 'main.go', content: 'package main\nimport "fmt"\nfunc main() { fmt.Println("Hello") }' },
        { name: 'Service.java', content: 'package com.test; import java.util.List; public class Service {}' }
      ];
      ...
      const mockResults = [
        {
          ...
          language: 'typescript',
          extractedData: { imports: [{ source: 'react', specifiers: ['React'], type: 'default' }] },
          interpretedData: { dependencyAnalysis: { external: ['react'], internal: [], summary: { total: 1, external: 1, internal: 0 } } },
          performanceMetrics: { parseTime: 15, extractionTime: 5, interpretationTime: 3, totalTime: 23, memoryUsage: 1024 },
          errors: []
        },
        {
          filePath: filePaths[1],
          language: 'javascript',
          extractedData: { imports: [{ source: 'express', type: 'require', specifiers: ['express'] }] },
          interpretedData: { dependencyAnalysis: { external: ['express'], internal: [], summary: { total: 1, external: 1, internal: 0 } } },
          performanceMetrics: { parseTime: 12, extractionTime: 4, interpretationTime: 2, totalTime: 18, memoryUsage: 768 },
          errors: []
        },
        {
          filePath: filePaths[2],
          language: 'go',
          extractedData: { package: 'main', imports: [{ path: 'fmt', type: 'standard' }] },
          interpretedData: { dependencyAnalysis: { standard: ['fmt'], external: [], internal: [], summary: { total: 1, standard: 1, external: 0, internal: 0 } } },
          performanceMetrics: { parseTime: 18, extractionTime: 6, interpretationTime: 3, totalTime: 27, memoryUsage: 1280 },
          errors: []
        },
        {
          filePath: filePaths[3],
          language: 'java',
          extractedData: { package: 'com.test', imports: [{ class: 'java.util.List', type: 'standard' }] },
          interpretedData: { dependencyAnalysis: { standard: ['java.util'], external: [], internal: [], summary: { total: 1, standard: 1, external: 0, internal: 0 } } },
          performanceMetrics: { parseTime: 22, extractionTime: 8, interpretationTime: 4, totalTime: 34, memoryUsage: 1536 },
          errors: []
        }
      ];
      ...
      expect(results.map((r: any) => r.language)).toEqual(['typescript', 'javascript', 'go', 'java']);
      expect(results.every((r: any) => r.errors.length === 0)).toBe(true);

      // Verify performance across languages
      const totalTime = results.reduce((sum: number, r: any) => sum + r.performanceMetrics.totalTime, 0);
  ...
  describe('Cross-Language Dependency Analysis', () => {
    test('should identify dependencies across language boundaries', async () => {
      ...
      const mockCrossLanguageResult = {
        ...
        totalFiles: 4,
        dependencyMatrix: {
          typescript: { external: ['react', '@types/node'], internal: ['../backend/api'] },
          javascript: { external: ['express', 'cors'], internal: ['../services/auth-client'] },
          go: { external: ['github.com/gorilla/mux'], internal: ['./config', './handlers'] },
          java: { external: ['org.springframework'], internal: ['com.project.model'] }
        },
        crossLanguageDependencies: [
          { from: 'frontend/app.tsx', to: 'backend/server.js', type: 'api-call' },
          { from: 'backend/server.js', to: 'services/auth.go', type: 'service-call' }
        ],
        insights: {
      ...
      expect(result[0].insights.dependencyHotspots).toContain('backend/server.js');
    });
  });
});