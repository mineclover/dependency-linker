...
(0, globals_1.describe)("Unknown Symbol System", () => {
	...
	(0, globals_1.describe)("Equivalence Inference Engine", () => {
		(0, globals_1.it)(
			"should infer equivalence with exact name match",
			async () => {
				const unknown = {
					id: "unknown_1",
					name: "User",
		...
		(0, globals_1.it)(
			"should infer equivalence with type-based match",
			async () => {
				const unknown = {
					id: "unknown_2",
					name: "user",
		...
		(0, globals_1.it)(
			"should infer equivalence with context-based match",
			async () => {
				const unknown = {
					id: "unknown_3",
					name: "UserService",
	...
	(0, globals_1.describe)("Unknown Symbol Handler", () => {
		(0, globals_1.it)(
			"should register unknown symbol via handler",
			async () => {
				const options = {
					file: "src/types.ts",
					symbol: "User",
	...
	(0, globals_1.describe)("Integration Tests", () => {
		(0, globals_1.it)(
			"should complete full workflow: register -> search -> infer -> create relation",
			async () => {
