...
(0, globals_1.describe)("Dependency Graph Analysis", () => {
    ...
    (0, globals_1.describe)("High-level API", () => {
        (0, globals_1.it)("should perform complete dependency analysis", async () => {
            const result = await (0, graph_1.analyzeDependencyGraph)(testProjectRoot, ["src/index.ts"], {
                maxDepth: 3,
                includeExternalDependencies: false,
            });
            (0, globals_1.expect)(result.buildResult).toBeDefined();
            (0, globals_1.expect)(result.analysisResult).toBeDefined();
            (0, globals_1.expect)(result.buildResult.graph.nodes.size).toBeGreaterThan(0);
            (0, globals_1.expect)(result.buildResult.processedFiles).toBeGreaterThan(0);
            (0, globals_1.expect)(typeof result.analysisResult.circularDependencies.totalCycles).toBe("number");
            (0, globals_1.expect)(typeof result.analysisResult.dependencyDepth.maxDepth).toBe("number");
        });
        (0, globals_1.it)("should create dependency analyzer with proper state management", async () => {
