...
(0, globals_1.describe)(
	"CLI 분석 통합 테스트 - 전체 시멘틱 태그 및 심볼 타입",
	() => {
		...
		(0, globals_1.describe)("Node Types (노드 타입) 분석", () => {
			...
			(0, globals_1.it)(
				"should validate all Code Symbol Types (LSP-based)",
				() => {
			...
			(0, globals_1.it)("should validate all Declaration Types", () => {
				const declarationTypes = ["export", "import"];
			...
			(0, globals_1.it)("should validate all Documentation Types", () => {
				const documentationTypes = ["heading-symbol", "symbol"];
			...
			(0, globals_1.it)("should validate all Error Types", () => {
				const errorTypes = ["file_not_found", "broken_reference"];
		...
		(0, globals_1.describe)("Edge Types (엣지 타입) 분석", () => {
			(0, globals_1.it)("should validate all Structural Relationships", () => {
				const structuralRelationships = ["contains", "declares", "belongs_to"];
			...
			(0, globals_1.it)(
				"should validate all Code Execution Relationships",
				() => {
			...
			(0, globals_1.it)(
				"should validate all Modification Relationships",
				() => {
			...
			(0, globals_1.it)(
				"should validate all Documentation Relationships",
				() => {
			...
			(0, globals_1.it)("should validate all Meta Relationships", () => {
				const metaRelationships = ["annotated_with", "references"];
		...
		(0, globals_1.describe)("Supported Languages (지원 언어) 분석", () => {
			(0, globals_1.it)(
				"should validate all supported programming languages",
				() => {
			...
			(0, globals_1.it)("should validate file extension mappings", () => {
				...
				(0, globals_1.expect)(Object.keys(fileExtensionMappings).length).toBe(
					10,
				);
				(0, globals_1.expect)(fileExtensionMappings.typescript).toEqual([
					"ts",
					"tsx",
				]);
				(0, globals_1.expect)(fileExtensionMappings.javascript).toEqual([
					"js",
					"jsx",
				]);
				(0, globals_1.expect)(fileExtensionMappings.python).toEqual([
					"py",
					"pyi",
				]);
				(0, globals_1.expect)(fileExtensionMappings.markdown).toEqual([
					"md",
					"markdown",
					"mdx",
				]);
		...
		(0, globals_1.describe)("CLI 명령어별 분석 타입", () => {
			...
			(0, globals_1.it)("should validate Unknown Symbol analysis types", () => {
				...
				(0, globals_1.expect)(unknownSymbolTypes.equivalenceTypes.length).toBe(
					2,
				);
			...
			(0, globals_1.it)(
				"should validate Cross-Namespace analysis types",
				() => {
					...
					(0, globals_1.expect)(crossNamespaceTypes.namespaceTypes.length).toBe(
						3,
					);
					(0, globals_1.expect)(
						crossNamespaceTypes.dependencyTypes.length,
					).toBe(3);
					(0, globals_1.expect)(crossNamespaceTypes.analysisTypes.length).toBe(
						3,
					);
			...
			(0, globals_1.it)("should validate Inference analysis types", () => {
				...
				(0, globals_1.expect)(
					inferenceAnalysisTypes.inferenceTypes.length,
				).toBe(3);
				(0, globals_1.expect)(inferenceAnalysisTypes.edgeTypes.length).toBe(4);
				(0, globals_1.expect)(
					inferenceAnalysisTypes.confidenceTypes.length,
				).toBe(3);
				console.log("✅ Inference Analysis Types 검증 완료");
			});
			(0, globals_1.it)(
				"should validate Context Documents analysis types",
				() => {
					...
					(0, globals_1.expect)(
						contextDocumentsTypes.documentTypes.length,
					).toBe(3);
					(0, globals_1.expect)(contextDocumentsTypes.formatTypes.length).toBe(
						3,
					);
					(0, globals_1.expect)(contextDocumentsTypes.contentTypes.length).toBe(
						4,
					);
			...
			(0, globals_1.it)(
				"should validate Performance Optimization analysis types",
				() => {
					...
					(0, globals_1.expect)(
						performanceOptimizationTypes.optimizationTypes.length,
					).toBe(3);
					(0, globals_1.expect)(
						performanceOptimizationTypes.metricTypes.length,
					).toBe(4);
					(0, globals_1.expect)(
						performanceOptimizationTypes.visualizationTypes.length,
					).toBe(4);
		...
		(0, globals_1.describe)("파싱 타입별 분석", () => {
			(0, globals_1.it)("should validate TypeScript parsing types", () => {
				...
				(0, globals_1.expect)(typescriptParsingTypes.fileExtensions).toEqual([
					"ts",
					"tsx",
				]);
				...
				(0, globals_1.expect)(typescriptParsingTypes.semanticTags.length).toBe(
					3,
				);
			...
			(0, globals_1.it)("should validate JavaScript parsing types", () => {
				...
				(0, globals_1.expect)(javascriptParsingTypes.fileExtensions).toEqual([
					"js",
					"jsx",
				]);
				...
				(0, globals_1.expect)(javascriptParsingTypes.semanticTags.length).toBe(
					3,
				);
			...
			(0, globals_1.it)("should validate Java parsing types", () => {
				...
				(0, globals_1.expect)(javaParsingTypes.fileExtensions).toEqual([
					"java",
				]);
			...
			(0, globals_1.it)("should validate Python parsing types", () => {
				...
				(0, globals_1.expect)(pythonParsingTypes.fileExtensions).toEqual([
					"py",
					"pyi",
				]);
		...
		(0, globals_1.describe)("통합 분석 시나리오", () => {
			(0, globals_1.it)("should validate complete analysis workflow", () => {
				...
				(0, globals_1.expect)(completeWorkflow.step2.symbolTypes.length).toBe(
					3,
				);
				(0, globals_1.expect)(completeWorkflow.step3.queryTypes.length).toBe(3);
				(0, globals_1.expect)(
					completeWorkflow.step4.namespaceTypes.length,
				).toBe(3);
				(0, globals_1.expect)(
					completeWorkflow.step5.inferenceTypes.length,
				).toBe(3);
				(0, globals_1.expect)(completeWorkflow.step6.documentTypes.length).toBe(
					3,
				);
				(0, globals_1.expect)(
					completeWorkflow.step7.optimizationTypes.length,
				).toBe(3);
