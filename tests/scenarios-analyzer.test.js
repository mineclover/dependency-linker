...
(0, globals_1.describe)("BaseScenarioAnalyzer", () => {
    ...
    (0, globals_1.describe)("constructor and getters", () => {
        ...
        (0, globals_1.it)("should return empty config if not specified", () => {
            ...
            const analyzerWithoutConfig = new TestAnalyzer(specWithoutConfig, registry);
    ...
    (0, globals_1.describe)("execution lifecycle", () => {
        ...
        (0, globals_1.it)("should store result in context after execution", async () => {
            const context = {
                filePath: "test.ts",
                sourceCode: "export class Test {}",
                language: "typescript",
            ...
            (0, globals_1.expect)(context.previousResults.get("test-scenario")).toEqual(result);
        });
        (0, globals_1.it)("should allow result modification in afterAnalyze", async () => {
            ...
            (0, globals_1.expect)(result.nodes[1].properties).toEqual({ added: true });
        });
    });
    ...
    (0, globals_1.describe)("result helpers", () => {
        ...
        (0, globals_1.it)("should handle results without semantic tags in merge", () => {
            const result1 = {
                nodes: [{ type: "file", identifier: "file1.ts" }],
                edges: [],
            };
    ...
    (0, globals_1.describe)("context analysis", () => {
        (0, globals_1.it)("should analyze with full context information", async () => {
            const context = {
            ...
            (0, globals_1.expect)(result.nodes[0].properties?.language).toBe("typescript");
        });
    });
});
