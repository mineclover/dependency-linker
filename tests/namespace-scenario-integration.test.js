...
(0, globals_1.describe)("Namespace-Scenario Integration - Phase 2", () => {
	...
	(0, globals_1.beforeEach)(async () => {
		...
		await (0, promises_1.mkdir)((0, node_path_1.join)(tempDir, "tests"), {
			recursive: true,
		});
		await (0, promises_1.mkdir)((0, node_path_1.join)(tempDir, "docs"), {
			recursive: true,
		});
	});
	...
	(0, globals_1.describe)("Scenario Execution Order Calculation", () => {
		(0, globals_1.it)(
			"should calculate execution order for namespace with explicit scenarios",
			async () => {
				await (0, promises_1.writeFile)(
					(0, node_path_1.join)(tempDir, "src", "index.ts"),
		...
		(0, globals_1.it)(
			"should use default scenarios when not specified (backward compatibility)",
			async () => {
				await (0, promises_1.writeFile)(
					(0, node_path_1.join)(tempDir, "src", "index.ts"),
					"export const hello = 'world';",
		...
		(0, globals_1.it)(
			"should handle single scenario with dependencies",
			async () => {
				await (0, promises_1.writeFile)(
					(0, node_path_1.join)(tempDir, "docs", "README.md"),
					"# Hello World\n[Link](./other.md)",
				);
				const config = {
		...
		(0, globals_1.it)(
			"should resolve dependency chains correctly",
			async () => {
				await (0, promises_1.writeFile)(
					(0, node_path_1.join)(tempDir, "src", "code.ts"),
					"export class Test {}",
				);
				const config = {
					filePatterns: ["src/**/*.ts"],
	...
	(0, globals_1.describe)(
		"Multiple Namespaces with Different Scenarios",
		() => {
			(0, globals_1.it)(
				"should apply different scenarios to different namespaces",
				async () => {
					await (0, promises_1.writeFile)(
						(0, node_path_1.join)(tempDir, "src", "app.ts"),
						"export const app = 'test';",
					);
					await (0, promises_1.writeFile)(
						(0, node_path_1.join)(tempDir, "tests", "app.test.ts"),
						"import { app } from '../src/app';",
					);
					await (0, promises_1.writeFile)(
						(0, node_path_1.join)(tempDir, "docs", "guide.md"),
						"# Guide\n[API](./api.md)",
					);
					const sourceConfig = {
						filePatterns: ["src/**/*.ts"],
	...
	(0, globals_1.describe)("analyzeNamespaceWithGraph", () => {
		(0, globals_1.it)(
			"should include scenario execution order in result",
			async () => {
				await (0, promises_1.writeFile)(
					(0, node_path_1.join)(tempDir, "src", "index.ts"),
	...
	(0, globals_1.describe)("Empty Namespace Handling", () => {
		(0, globals_1.it)(
			"should include scenarios even when no files match",
			async () => {
				const config = {
	...
	(0, globals_1.describe)("Backward Compatibility", () => {
		(0, globals_1.it)(
			"should work with namespaces created before scenario support",
			async () => {
				await (0, promises_1.writeFile)(
					(0, node_path_1.join)(tempDir, "src", "legacy.ts"),
		...
		(0, globals_1.it)(
			"should preserve existing functionality when scenarios are not used",
			async () => {
				await (0, promises_1.writeFile)(
					(0, node_path_1.join)(tempDir, "src", "old.ts"),
