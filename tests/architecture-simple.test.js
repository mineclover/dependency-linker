...
(0, globals_1.describe)("간단한 아키텍처 검증 테스트", () => {
	...
	(0, globals_1.describe)(
		...
		() => {
			(0, globals_1.it)("should validate RDF Handler responsibility", () => {
				...
				(0, globals_1.expect)(rdfHandler.methods).toContain(
					"generateRDFAddress",
				);
			...
			(0, globals_1.it)(
				"should validate Unknown Symbol Handler responsibility",
				() => {
					...
					(0, globals_1.expect)(unknownHandler.name).toBe(
						"UnknownSymbolHandler",
					);
					(0, globals_1.expect)(unknownHandler.responsibility).toContain(
						"Unknown Symbol",
					);
					(0, globals_1.expect)(unknownHandler.methods).toContain(
						"registerUnknownSymbol",
					);
					(0, globals_1.expect)(unknownHandler.methods).toContain(
						"searchUnknownSymbol",
			...
			(0, globals_1.it)("should validate Query Handler responsibility", () => {
				...
				(0, globals_1.expect)(queryHandler.methods).toContain(
					"executeNaturalLanguage",
				);
				console.log("✅ Query Handler 단일 책임 검증 완료");
			});
			(0, globals_1.it)(
				"should validate Cross-Namespace Handler responsibility",
				() => {
					...
					(0, globals_1.expect)(crossNamespaceHandler.name).toBe(
						"CrossNamespaceHandler",
					);
					(0, globals_1.expect)(crossNamespaceHandler.responsibility).toContain(
						"Cross-Namespace",
					);
					(0, globals_1.expect)(crossNamespaceHandler.methods).toContain(
						"analyzeCrossNamespace",
					);
					(0, globals_1.expect)(crossNamespaceHandler.methods).toContain(
						"detectCircularDependencies",
			...
			(0, globals_1.it)(
				"should validate Inference Handler responsibility",
				() => {
					...
					(0, globals_1.expect)(inferenceHandler.responsibility).toContain(
						"추론",
					);
					(0, globals_1.expect)(inferenceHandler.methods).toContain(
						"executeInference",
					);
					(0, globals_1.expect)(inferenceHandler.methods).toContain(
						"hierarchicalInference",
			...
			(0, globals_1.it)(
				"should validate Context Documents Handler responsibility",
				() => {
					...
					(0, globals_1.expect)(contextDocumentsHandler.name).toBe(
						"ContextDocumentsHandler",
					);
					(0, globals_1.expect)(
						contextDocumentsHandler.responsibility,
					).toContain("컨텍스트 문서");
					(0, globals_1.expect)(contextDocumentsHandler.methods).toContain(
						"generateFileContext",
					);
					(0, globals_1.expect)(contextDocumentsHandler.methods).toContain(
						"generateSymbolContext",
			...
			(0, globals_1.it)(
				"should validate Performance Optimization Handler responsibility",
				() => {
					...
					(0, globals_1.expect)(performanceHandler.name).toBe(
						"PerformanceOptimizationHandler",
					);
					(0, globals_1.expect)(performanceHandler.responsibility).toContain(
						"성능",
					);
					(0, globals_1.expect)(performanceHandler.methods).toContain(
						"analyzeProject",
					);
					(0, globals_1.expect)(performanceHandler.methods).toContain(
						"manageCache",
					...
					console.log(
						"✅ Performance Optimization Handler 단일 책임 검증 완료",
					);
				},
			);
		},
	...
	(0, globals_1.describe)(
		"의존성 역전 원칙 (Dependency Inversion Principle) 검증",
		() => {
			(0, globals_1.it)(
				"should validate factory pattern implementation",
				() => {
					...
					(0, globals_1.expect)(factoryPattern.benefits).toContain(
						"의존성 주입",
					);
					(0, globals_1.expect)(factoryPattern.benefits).toContain(
						"싱글톤 관리",
			...
			(0, globals_1.it)(
				"should validate singleton pattern implementation",
				() => {
					...
					(0, globals_1.expect)(singletonPattern.pattern).toBe(
						"Singleton Pattern",
					);
					(0, globals_1.expect)(singletonPattern.benefits.length).toBe(3);
					(0, globals_1.expect)(singletonPattern.benefits).toContain(
						"메모리 효율성",
					);
					(0, globals_1.expect)(singletonPattern.benefits).toContain(
						"일관된 상태",
					...
					(0, globals_1.expect)(singletonPattern.implementation).toContain(
						"HandlerFactory",
					);
			...
			(0, globals_1.it)("should validate abstraction over concretion", () => {
				...
				(0, globals_1.expect)(abstractionPrinciple.principle).toBe(
					"추상화 우선 원칙",
				);
				(0, globals_1.expect)(abstractionPrinciple.benefits.length).toBe(4);
				(0, globals_1.expect)(abstractionPrinciple.benefits).toContain(
					"유연성",
				);
				(0, globals_1.expect)(abstractionPrinciple.benefits).toContain(
					"확장성",
				...
				(0, globals_1.expect)(abstractionPrinciple.implementation).toContain(
					"인터페이스",
				);
	...
	(0, globals_1.describe)("확장성 (Scalability) 검증", () => {
		(0, globals_1.it)("should validate easy addition of new handlers", () => {
			...
			(0, globals_1.expect)(newHandlerTemplate.responsibility).toBe(
			...
			(0, globals_1.expect)(newHandlerTemplate.factoryMethod).toBe(
				"getNewFeatureHandler",
			);
			console.log("✅ 새로운 핸들러 추가 용이성 검증 완료");
		});
		(0, globals_1.it)(
			"should validate easy addition of new CLI commands",
			() => {
				...
				(0, globals_1.expect)(newCommandTemplate.description).toBe(
					"New Feature Management",
				);
				(0, globals_1.expect)(newCommandTemplate.handler).toBe(
					"NewFeatureHandler",
				);
				(0, globals_1.expect)(newCommandTemplate.options.length).toBe(2);
				(0, globals_1.expect)(newCommandTemplate.options[0].name).toBe(
					"--option1",
				);
				(0, globals_1.expect)(newCommandTemplate.options[1].name).toBe(
					"--option2",
				);
	...
	(0, globals_1.describe)("테스트 용이성 (Testability) 검증", () => {
		...
		(0, globals_1.it)("should validate dependency injection support", () => {
			...
			(0, globals_1.expect)(typeof mockDependencies.database.connect).toBe(
				"function",
			);
			(0, globals_1.expect)(typeof mockDependencies.cache.get).toBe("function");
			(0, globals_1.expect)(typeof mockDependencies.logger.info).toBe(
				"function",
			);
