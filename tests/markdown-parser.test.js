...
(0, globals_1.describe)("마크다운 파서 테스트", () => {
	...
	(0, globals_1.beforeAll)(() => {
		...
		headingExtractor =
			new MarkdownHeadingExtractor_js_1.MarkdownHeadingExtractor();
		tagCollector = new MarkdownTagCollector_js_1.MarkdownTagCollector();
		tagHeadingMapper =
			new MarkdownTagHeadingMapper_js_1.MarkdownTagHeadingMapper();
		tagConventionManager =
			new MarkdownTagConventionManager_js_1.MarkdownTagConventionManager();
		tagDocumentGenerator =
			new MarkdownTagDocumentGenerator_js_1.MarkdownTagDocumentGenerator();
		tagTypeValidator =
			new MarkdownTagTypeValidator_js_1.MarkdownTagTypeValidator();
		tagTypeDocumentGenerator =
			new MarkdownTagTypeDocumentation_js_1.MarkdownTagTypeDocumentGenerator();
	});
...
[내부 링크 3](../../config/settings.md)`;
			...
			(0, globals_1.expect)(links.internal[2].path).toBe(
				"../../config/settings.md",
			);
		});
...
[외부 링크 3](mailto:contact@example.com)`;
			...
			(0, globals_1.expect)(links.external[1].url).toBe(
				"https://github.com/user/repo",
			);
			(0, globals_1.expect)(links.external[2].url).toBe(
...
[통합 테스트](tests/integration.md) #테스트`;
			...
			(0, globals_1.expect)(links.internal[3].path).toBe(
