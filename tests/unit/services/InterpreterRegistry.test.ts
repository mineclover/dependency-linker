...
import type {
	...
	InterpreterContext,
} from "../../../src/interpreters/IDataInterpreter";
...
class MockInterpreter
	implements IDataInterpreter<MockInputData, MockInterpretedResult>
{
	private name: string;
...
describe("InterpreterRegistry", () => {
	...
	describe("Data Type Support", () => {
		...
		test("should support language-specific data type filtering", () => {
			...
			generalInterpreter.supports = (dataType: string) =>
	...
	describe("Processing Chain", () => {
		...
		test("should get compatible interpreters for data processing chain", () => {
			...
			depInterpreter.supports = (dataType: string) =>
				dataType === "dependencies";
	...
	describe("Error Handling", () => {
		...
		test("should handle processing errors in interpreter chain", () => {
			...
			expect(() => interpreter.interpret({}, context)).toThrow(
				"Processing failed",
			);
		});
	});
