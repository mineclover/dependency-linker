...
#### 세부 항목 3.1.1 #테스트`;
    ...
    (0, globals_1.describe)("기본 CLI 명령어 테스트", () => {
        ...
        (0, globals_1.it)("성능 모니터링과 함께 분석", async () => {
            ...
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Performance monitoring enabled");
        });
    });
    (0, globals_1.describe)("태그 분석 CLI 명령어 테스트", () => {
        (0, globals_1.it)("태그 수집", async () => {
            ...
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Tag collection completed");
        });
        (0, globals_1.it)("태그-헤딩 매핑", async () => {
            ...
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Tag-heading mapping completed");
        });
        (0, globals_1.it)("태그 문서 생성", async () => {
            ...
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Tag documentation generated");
        });
    });
    (0, globals_1.describe)("태그 유형 검증 CLI 명령어 테스트", () => {
        (0, globals_1.it)("태그 유형 검증", async () => {
            ...
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Tag type validation completed");
        });
        (0, globals_1.it)("태그 유형 문서 생성", async () => {
            ...
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Tag type documentation generated");
        });
    });
    (0, globals_1.describe)("명세서 기반 CLI 명령어 테스트", () => {
        (0, globals_1.it)("태그 유형 로드", async () => {
            ...
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Tag types loaded successfully");
        });
        (0, globals_1.it)("코드 파싱 대상 로드", async () => {
            const result = await runCLICommand(["spec", "--load-code-targets"]);
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Code parsing targets loaded successfully");
        });
        (0, globals_1.it)("마크다운 파싱 대상 로드", async () => {
            const result = await runCLICommand(["spec", "--load-markdown-targets"]);
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Markdown parsing targets loaded successfully");
        });
        (0, globals_1.it)("명세서 검증", async () => {
            const result = await runCLICommand(["spec", "--validate-spec"]);
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Specification format is valid");
        });
        (0, globals_1.it)("명세서 생성", async () => {
            const result = await runCLICommand(["spec", "--generate-spec"]);
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Specification generated successfully");
        });
    });
    (0, globals_1.describe)("namespace 최적화 CLI 명령어 테스트", () => {
        (0, globals_1.it)("namespace 최적화", async () => {
            ...
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Namespace optimization completed");
        });
        (0, globals_1.it)("모든 namespace 최적화", async () => {
            const result = await runCLICommand(["spec", "--optimize-all"]);
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("All namespaces optimization completed");
        });
        (0, globals_1.it)("성능 통계 조회", async () => {
            const result = await runCLICommand(["spec", "--performance-stats"]);
            (0, globals_1.expect)(result.success).toBe(true);
            (0, globals_1.expect)(result.output).toContain("Performance statistics gathered");
        });
    });
    ...
    async function runCLICommand(args) {
        return new Promise((resolve) => {
            const child = (0, child_process_1.spawn)("node", ["dist/cli/main.js", ...args], {
