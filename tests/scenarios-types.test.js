...
(0, globals_1.describe)("Scenario Type Validation", () => {
	(0, globals_1.describe)("isValidVersion", () => {
		(0, globals_1.it)("should accept valid semantic versions", () => {
			(0, globals_1.expect)((0, validation_1.isValidVersion)("1.0.0")).toBe(
				true,
			);
			(0, globals_1.expect)((0, validation_1.isValidVersion)("0.1.0")).toBe(
				true,
			);
			(0, globals_1.expect)((0, validation_1.isValidVersion)("10.20.30")).toBe(
				true,
			);
		});
		(0, globals_1.it)("should reject invalid versions", () => {
			(0, globals_1.expect)((0, validation_1.isValidVersion)("1.0")).toBe(
				false,
			);
			(0, globals_1.expect)((0, validation_1.isValidVersion)("v1.0.0")).toBe(
				false,
			);
			(0, globals_1.expect)(
				(0, validation_1.isValidVersion)("1.0.0-alpha"),
			).toBe(false);
			(0, globals_1.expect)((0, validation_1.isValidVersion)("invalid")).toBe(
				false,
			);
		});
	});
	(0, globals_1.describe)("isValidScenarioId", () => {
		(0, globals_1.it)("should accept valid scenario IDs", () => {
			(0, globals_1.expect)(
				(0, validation_1.isValidScenarioId)("react-component"),
			).toBe(true);
			(0, globals_1.expect)(
				(0, validation_1.isValidScenarioId)("file-dependency"),
			).toBe(true);
			(0, globals_1.expect)(
				(0, validation_1.isValidScenarioId)("basic-structure"),
			).toBe(true);
			(0, globals_1.expect)(
				(0, validation_1.isValidScenarioId)("markdown-linking"),
			).toBe(true);
		});
		(0, globals_1.it)("should reject invalid scenario IDs", () => {
			(0, globals_1.expect)(
				(0, validation_1.isValidScenarioId)("ReactComponent"),
			).toBe(false);
			(0, globals_1.expect)(
				(0, validation_1.isValidScenarioId)("react_component"),
			).toBe(false);
			(0, globals_1.expect)(
				(0, validation_1.isValidScenarioId)("123-component"),
			).toBe(false);
			(0, globals_1.expect)(
				(0, validation_1.isValidScenarioId)("react component"),
			).toBe(false);
	...
	(0, globals_1.describe)("validateNodeTypeSpec", () => {
		...
		(0, globals_1.it)(
			"should validate NodeTypeSpec with defaultProperties",
			() => {
				const validSpec = {
					name: "class",
		...
		(0, globals_1.it)("should reject invalid defaultProperties", () => {
			...
			const result = (0, validation_1.validateNodeTypeSpec)(invalidSpec);
			(0, globals_1.expect)(result.valid).toBe(false);
			(0, globals_1.expect)(result.errors).toContain(
	...
	(0, globals_1.describe)("validateEdgeTypeSpec", () => {
		...
		(0, globals_1.it)(
			"should validate EdgeTypeSpec with all properties",
			() => {
				const validSpec = {
					name: "imports_file",
	...
	(0, globals_1.describe)("validateScenarioSpec", () => {
		...
		(0, globals_1.it)(
			"should validate ScenarioSpec with extends and requires",
			() => {
				const validSpec = {
					id: "react-component",
		...
		(0, globals_1.it)("should reject ScenarioSpec without id", () => {
			...
			(0, globals_1.expect)(result.valid).toBe(false);
			(0, globals_1.expect)(
				result.errors.some((e) => e.includes("id is required")),
			).toBe(true);
		});
	...
	(0, globals_1.describe)("detectCircularDependencies", () => {
		(0, globals_1.it)("should detect direct circular dependency", () => {
			...
			const result = (0, validation_1.detectCircularDependencies)(
				"scenario-a",
				specs,
			);
		...
		(0, globals_1.it)(
			"should not detect circular dependency in valid chain",
			() => {
				const specs = new Map([
					[
						"scenario-a",
		...
		(0, globals_1.it)(
			"should handle requires dependencies for circular detection",
			() => {
				const specs = new Map([
					[
						"scenario-a",
