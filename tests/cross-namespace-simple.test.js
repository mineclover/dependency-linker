...
(0, globals_1.describe)("Cross-Namespace Dependencies - Simple Test", () => {
    ...
    (0, globals_1.it)("should validate cross-namespace dependency structure", () => {
        ...
        (0, globals_1.expect)(mockCrossDependency.sourceNamespace).toBe("frontend");
        (0, globals_1.expect)(mockCrossDependency.targetNamespace).toBe("backend");
        (0, globals_1.expect)(mockCrossDependency.source).toBe("src/components/UserComponent.tsx");
        (0, globals_1.expect)(mockCrossDependency.target).toBe("src/api/userService.ts");
    ...
    (0, globals_1.it)("should validate circular dependency structure", () => {
        ...
        (0, globals_1.expect)(mockCircularDependency[0]).toBe(mockCircularDependency[mockCircularDependency.length - 1]);
    ...
    (0, globals_1.it)("should validate namespace statistics structure", () => {
        ...
        (0, globals_1.expect)(mockNamespaceStats.crossNamespaceDependencies.outgoing).toBe(8);
        (0, globals_1.expect)(mockNamespaceStats.crossNamespaceDependencies.incoming).toBe(3);
    ...
    (0, globals_1.it)("should validate configuration options", () => {
        ...
        (0, globals_1.expect)(configOptions.configPath).toBe("dependency-linker.config.json");
    ...
    (0, globals_1.it)("should validate analysis options", () => {
        ...
        (0, globals_1.expect)(analysisOptions.includeCircularDependencies).toBe(true);
