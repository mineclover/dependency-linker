...
describe("Core System Functionality", () => {
    beforeAll(() => {
        QueryEngine_1.globalQueryEngine
            .getRegistry()
            .register("ts-import-sources", (0, test_helpers_1.createMockQueryFunction)("ts-import-sources"));
        QueryEngine_1.globalQueryEngine
            .getRegistry()
            .register("ts-named-imports", (0, test_helpers_1.createMockQueryFunction)("ts-named-imports"));
        QueryEngine_1.globalQueryEngine
            .getRegistry()
            .register("ts-export-declarations", (0, test_helpers_1.createMockQueryFunction)("ts-export-declarations"));
    });
    describe("CustomKeyMapper Basic Operations", () => {
        ...
        test("should fail validation with unregistered queries", () => {
            ...
            const mapper = (0, CustomKeyMapper_1.createCustomKeyMapper)(invalidMapping);
            const validation = mapper.validate();
