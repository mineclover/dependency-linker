...
(0, globals_1.describe)("Namespace Configuration - Phase 1", () => {
	...
	(0, globals_1.beforeEach)(async () => {
		...
		tempDir = await (0, promises_1.mkdtemp)(
			(0, node_path_1.join)((0, node_os_1.tmpdir)(), "namespace-config-test-"),
		);
	...
	(0, globals_1.describe)("NamespaceConfig Type Extensions", () => {
		(0, globals_1.it)(
			"should accept scenarios field in NamespaceConfig",
			async () => {
				const config = {
					filePatterns: ["src/**/*.ts"],
				...
				(0, globals_1.expect)(loaded.scenarios).toEqual([
					"basic-structure",
					"file-dependency",
				]);
			},
		...
		(0, globals_1.it)(
			"should accept scenarioConfig field in NamespaceConfig",
			async () => {
				const config = {
					filePatterns: ["src/**/*.ts"],
		...
		(0, globals_1.it)(
			"should allow optional scenarios and scenarioConfig fields",
			async () => {
				const config = {
					filePatterns: ["src/**/*.ts"],
				};
	...
	(0, globals_1.describe)("ConfigManager Scenario Validation", () => {
		(0, globals_1.it)(
			"should validate scenario IDs when setting namespace config",
			async () => {
				const config = {
					filePatterns: ["src/**/*.ts"],
					scenarios: ["basic-structure", "file-dependency"],
		...
		(0, globals_1.it)(
			"should reject mixed valid and invalid scenario IDs",
			async () => {
				const config = {
					filePatterns: ["src/**/*.ts"],
	...
	(0, globals_1.describe)("Configuration File Persistence", () => {
		...
		(0, globals_1.it)(
			"should support multiple namespaces with different scenarios",
			async () => {
				...
				(0, globals_1.expect)(configFile.namespaces.frontend.scenarios).toEqual(
					["basic-structure", "symbol-dependency"],
				);
	...
	(0, globals_1.describe)("Backward Compatibility", () => {
		(0, globals_1.it)(
			"should support namespaces without scenarios field",
			async () => {
				const config = {
					filePatterns: ["src/**/*.ts"],
					semanticTags: ["source"],
		...
		(0, globals_1.it)(
			"should preserve existing config fields when adding scenarios",
			async () => {
				const initialConfig = {
					filePatterns: ["src/**/*.ts"],
				...
				(0, globals_1.expect)(loaded.semanticTags).toEqual([
					"source",
					"production",
				]);
				(0, globals_1.expect)(loaded.scenarios).toEqual([
