...
(0, globals_1.describe)("Context Documents - Simple Test", () => {
    ...
    (0, globals_1.it)("should validate context document structure", () => {
        ...
        (0, globals_1.expect)(mockContextDocument.metadata.filePath).toBe("src/components/Button.tsx");
        (0, globals_1.expect)(mockContextDocument.metadata.namespace).toBe("components");
        (0, globals_1.expect)(mockContextDocument.metadata.language).toBe("typescript");
        (0, globals_1.expect)(mockContextDocument.metadata.generatedAt).toBe("2024-01-01T00:00:00.000Z");
        (0, globals_1.expect)(mockContextDocument.purpose).toBe("재사용 가능한 버튼 컴포넌트");
        (0, globals_1.expect)(mockContextDocument.concepts).toBe("UI 컴포넌트, 이벤트 처리, 스타일링");
        (0, globals_1.expect)(mockContextDocument.notes).toBe("다양한 크기와 색상 옵션을 지원하는 버튼 컴포넌트");
    ...
    (0, globals_1.it)("should validate document metadata structure", () => {
        ...
        (0, globals_1.expect)(mockDocumentMetadata.filePath).toBe("src/utils/helpers.ts");
        ...
        (0, globals_1.expect)(mockDocumentMetadata.generatedAt).toBe("2024-01-01T00:00:00.000Z");
    ...
    (0, globals_1.it)("should validate configuration options", () => {
        ...
        (0, globals_1.expect)(configOptions.outputPath).toBe(".dependency-linker/context");
