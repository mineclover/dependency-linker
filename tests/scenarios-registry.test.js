...
(0, globals_1.describe)("ScenarioRegistry", () => {
	...
	(0, globals_1.describe)("register", () => {
		...
		(0, globals_1.it)("should reject duplicate scenario ID", () => {
			...
			(0, globals_1.expect)(() => registry.register(spec)).toThrow(
				/already registered/,
			);
		});
		(0, globals_1.it)(
			"should reject scenario with undefined extends dependency",
			() => {
				const spec = {
					id: "child-scenario",
					name: "Child",
		...
		(0, globals_1.it)(
			"should reject scenario with undefined requires dependency",
			() => {
				const spec = {
					id: "child-scenario",
					name: "Child",
		...
		(0, globals_1.it)("should reject circular extends dependency", () => {
			...
			(0, globals_1.expect)(() => tempRegistry.register(circularC)).toThrow(
				/Circular dependency/,
			);
		});
	});
	(0, globals_1.describe)("get, has, list", () => {
		...
		(0, globals_1.it)(
			"should return undefined for non-existent scenario",
			() => {
	...
	(0, globals_1.describe)("getExecutionOrder", () => {
		...
		(0, globals_1.it)(
			"should return single scenario with no dependencies",
			() => {
		...
		(0, globals_1.it)("should resolve complex dependency graph", () => {
			...
			(0, globals_1.expect)(order.indexOf("basic-structure")).toBeLessThan(
			...
			(0, globals_1.expect)(order.indexOf("file-dependency")).toBeLessThan(
				order.indexOf("react-component"),
			);
			(0, globals_1.expect)(order.indexOf("symbol-dependency")).toBeLessThan(
				order.indexOf("react-component"),
			);
		...
		(0, globals_1.it)("should throw for non-existent scenario", () => {
			(0, globals_1.expect)(() =>
				registry.getExecutionOrder(["non-existent"]),
	...
	(0, globals_1.describe)("collectTypes", () => {
		...
		(0, globals_1.it)("should throw for non-existent scenario", () => {
			(0, globals_1.expect)(() =>
				registry.collectTypes("non-existent"),
			).toThrow(/not found/);
		});
	});
	(0, globals_1.describe)("validateTypeConsistency", () => {
		...
		(0, globals_1.it)("should detect conflicting edge type properties", () => {
			...
			(0, globals_1.expect)(result.errors[0]).toContain(
