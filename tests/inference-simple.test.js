...
(0, globals_1.describe)("Inference System - Simple Test", () => {
    ...
    (0, globals_1.it)("should validate inference result structure", () => {
        ...
        (0, globals_1.expect)(Array.isArray(mockInferenceResult.results)).toBe(true);
        ...
        (0, globals_1.expect)(mockInferenceResult.results[0].inferredRelationType).toBe("hierarchical");
        (0, globals_1.expect)(mockInferenceResult.executionTime).toBe(150);
        (0, globals_1.expect)(Array.isArray(mockInferenceResult.methodsUsed)).toBe(true);
        (0, globals_1.expect)(mockInferenceResult.methodsUsed).toContain("hierarchical");
        (0, globals_1.expect)(mockInferenceResult.methodsUsed).toContain("transitive");
        (0, globals_1.expect)(Array.isArray(mockInferenceResult.ruleResults)).toBe(true);
        (0, globals_1.expect)(mockInferenceResult.ruleResults.length).toBe(1);
        (0, globals_1.expect)(mockInferenceResult.ruleResults[0].ruleId).toBe("rule_1");
        (0, globals_1.expect)(mockInferenceResult.ruleResults[0].executed).toBe(true);
        (0, globals_1.expect)(mockInferenceResult.ruleResults[0].confidence).toBe(0.95);
    ...
    (0, globals_1.it)("should validate inference statistics structure", () => {
        ...
        (0, globals_1.expect)(mockInferenceStats.customRules.averageExecutionTime).toBe(120);
        (0, globals_1.expect)(mockInferenceStats.realTimeInference.executions).toBe(30);
        (0, globals_1.expect)(mockInferenceStats.realTimeInference.averageExecutionTime).toBe(100);
        (0, globals_1.expect)(mockInferenceStats.optimizedInference.executions).toBe(20);
        (0, globals_1.expect)(mockInferenceStats.optimizedInference.averageExecutionTime).toBe(80);
