  ...
  const validations: Array<{ name: string; test: () => void }> = [
    {
      ...
      test: () => {
        ...
        const _analyzeFile: (filePath: string) => Promise<AnalysisResult> = analyzer.analyzeFile.bind(analyzer);
        const _extractDependencies: (filePath: string) => Promise<string[]> = analyzer.extractDependencies.bind(analyzer);
    ...
    
    {
      ...
      test: () => {
        ...
        const _analyzeFile: typeof analyzeTypeScriptFile = analyzeTypeScriptFile;
