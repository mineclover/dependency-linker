...
function testCombinationFunctions() {
  ...
  function filterLocalImports(sources: ImportSourceResult[]): ImportSourceResult[] {
  ...
  console.log("- buildImportAnalysis: (sources[], namedImports[], ...) => ImportAnalysisResult");
  console.log("- filterPackageImports: ImportSourceResult[] => ImportSourceResult[]");
...
function testRealWorldScenarios() {
  ...
  console.log(`- 패키지 import: ${reactComponentAnalysis.sources.filter(s => s.type === "package").length}개`);
  console.log(`- 로컬 import: ${reactComponentAnalysis.sources.filter(s => s.type === "local").length}개`);
  console.log(`- Named import: ${reactComponentAnalysis.namedImports.length}개`);
  ...
  console.log(`- Namespace import: ${nodeServerAnalysis.namespaceImports.length}개`);
