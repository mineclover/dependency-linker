...
describe('ImportInfo Model', () => {
  ...
  describe('ImportSpecifier interface', () => {
    test('should create valid import specifier', () => {
      const specifier = createImportSpecifier('useState', 'useStateHook', 'named');
  ...
  describe('ImportInfo interface', () => {
    ...
    test('should create type-only imports', () => {
      const specifiers = [createNamedImportSpecifier('User'), createNamedImportSpecifier('Role')];
      const importInfo = createImportInfo('./types', specifiers, mockLocation, true);
    ...
    test('should detect import types correctly', () => {
      const defaultImport = createImportInfo('react', [createDefaultImportSpecifier('React')], mockLocation);
      const namedImport = createImportInfo('react', [createNamedImportSpecifier('useState')], mockLocation);
      const namespaceImport = createImportInfo('lodash', [createNamespaceImportSpecifier('_')], mockLocation);
      const sideEffectImport = createSideEffectImport('./styles.css', mockLocation);
    ...
    test('should generate import statistics', () => {
      const imports: ImportInfo[] = [
        ...
        createImportInfo('react', [createNamedImportSpecifier('useState')], mockLocation, true),
