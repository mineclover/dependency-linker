...
export class PathUtils {
	private static logger: Logger = createLogger("PathUtils");
	 ...
	 */
	private static normalizeWindowsPath(inputPath: string): string {
		let normalized = inputPath;
	 ...
	 */
	private static normalizePosixPath(inputPath: string): string {
		let normalized = inputPath;
	 ...
	 */
	private static normalizeUnicode(inputPath: string): string {
		try {
	 ...
	 */
	static resolvePath(inputPath: string, basePath?: string): string {
		try {
			if (basePath) {
	 ...
	 */
	static getSafeFilename(filename: string, platform?: NodeJS.Platform): string {
