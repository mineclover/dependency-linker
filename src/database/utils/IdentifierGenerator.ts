 ...
 */
export function generateFileIdentifier(filePath: string, projectRoot?: string): string {
 ...
 */
export function isIdentifierFromFile(identifier: string, filePath: string): boolean {
 ...
 */
export function compareExportIdentifiers(id1: string, id2: string): {
  sameName: boolean;
  sameFile: boolean;
  name1: string;
  name2: string;
