...
import { Task, TaskStatus, ValidationResult } from '../types';
...
export class TaskError extends Error {
  ...
  constructor(message: string, code: string, taskId?: string, context?: Record<string, any>) {
    super(message);
    this.name = 'TaskError';
    this.code = code;
    this.taskId = taskId;
...
export class TaskNotFoundError extends TaskError {
  constructor(taskId: string, context?: Record<string, any>) {
    super(`Task with ID '${taskId}' not found`, 'TASK_NOT_FOUND', taskId, context);
...
export class CircularDependencyError extends TaskDependencyError {
  ...
  constructor(taskId: string, dependencyTaskId: string, dependencyChain: string[], context?: Record<string, any>) {
...
export class TaskExecutionError extends TaskError {
  ...
  constructor(
    ...
    super(message, 'TASK_EXECUTION_ERROR', taskId, { ...context, executionPhase, originalError: originalError?.message });
...
export class TaskValidationError extends TaskError {
  ...
  constructor(
    ...
    super(
      ...
      taskId, 
      { ...context, validationResults, failedCriteriaCount: failedCriteria.length }
    );
...
export class TaskResourceError extends TaskError {
  ...
  constructor(
    ...
    super(
      ...
      'TASK_RESOURCE_ERROR', 
      taskId, 
      { ...context, resourceType, resourceLimit, currentUsage }
    );
...
export class TaskTimeoutError extends TaskError {
  ...
  constructor(
    ...
    super(message, 'TASK_TIMEOUT_ERROR', taskId, { ...context, timeout, actualDuration });
...
export class TaskConfigurationError extends TaskError {
  ...
  constructor(
    ...
    super(
      ...
      taskId, 
      { ...context, configurationField, configurationValue }
    );
...
export class TaskBatchError extends TaskError {
  ...
  constructor(
    ...
    super(
      ...
      'TASK_BATCH_ERROR', 
      undefined, 
      { ...context, batchId, failedTaskIds, errorCount: errors.length }
    );
...
export class TaskTemplateError extends TaskError {
  ...
  constructor(
    ...
    super(
      ...
      'TASK_TEMPLATE_ERROR', 
      undefined, 
      { ...context, templateId, templateOperation }
    );
...
export class TaskErrorFactory {
  static taskNotFound(taskId: string, context?: Record<string, any>): TaskNotFoundError {
  ...
  static circularDependency(
    ...
    return new CircularDependencyError(taskId, dependencyTaskId, dependencyChain, context);
  }
  ...
  static validationFailed(
    ...
    const failedCount = validationResults.filter(result => !result.passed).length;
...
export class TaskErrorHandler {
  ...
  static getRetryDelay(error: TaskError, attemptNumber: number): number {
