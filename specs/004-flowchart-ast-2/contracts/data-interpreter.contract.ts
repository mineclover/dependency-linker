...
export interface DependencyAnalysisInterpreter
...
export interface IdentifierAnalysisInterpreter
	extends IDataInterpreter<IdentifierData, IdentifierAnalysisResult> {
