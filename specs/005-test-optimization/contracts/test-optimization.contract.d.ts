...
export declare function validateTestAnalyzer(
	analyzer: ITestAnalyzer,
): Promise<boolean>;
export declare function validateTestOptimizer(
	optimizer: ITestOptimizer,
): Promise<boolean>;
export declare function validatePerformanceTracker(
	tracker: IPerformanceTracker,
): Promise<boolean>;
