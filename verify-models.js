...
try {
	execSync(
		"npx tsc src/models/optimization/TestSuite.ts --target es2020 --moduleResolution node --esModuleInterop --skipLibCheck --noEmit",
		{ stdio: "pipe" },
	);
...
try {
	execSync(
		"npx tsc src/models/optimization/OptimizationOpportunity.ts --target es2020 --moduleResolution node --esModuleInterop --skipLibCheck --noEmit",
		{ stdio: "pipe" },
	);
...
try {
	execSync(
		"npx tsc src/models/optimization/PerformanceBaseline.ts --target es2020 --moduleResolution node --esModuleInterop --skipLibCheck --noEmit",
		{ stdio: "pipe" },
	);
...
try {
	execSync(
		"npx tsc src/services/optimization/TestAnalyzer.ts --target es2020 --moduleResolution node --esModuleInterop --skipLibCheck --noEmit",
		{ stdio: "pipe" },
	);
...
try {
	execSync(
		"npx tsc src/services/optimization/PerformanceTracker.ts --target es2020 --moduleResolution node --esModuleInterop --skipLibCheck --noEmit",
		{ stdio: "pipe" },
	);
